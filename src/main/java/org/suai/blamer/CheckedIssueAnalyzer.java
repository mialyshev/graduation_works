...
public class CheckedIssueAnalyzer {
    ...
    public CheckedIssueAnalyzer(String path, String projectName) throws IOException {
        this.filePath = path;
    ...
    public ArrayList<Integer> getIssueNumbers() throws IOException {
    ...
    public void addNumbers(ArrayList<Integer> numbers) throws IOException {
        StringBuilder stringBuilder = new StringBuilder();
